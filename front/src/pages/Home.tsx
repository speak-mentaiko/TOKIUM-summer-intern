  ...
  <>
    ...
    <ul className="  justify-center hidden text-sm font-28px text-center text-gray-500 rounded-lg shadow sm:flex dark:divide-gray-700 dark:text-gray-400">
      <li className="w-full focus-within:z-10 items-center">
        <a href="#" key="auto" onClick={() => setAuto(true)}
           ...
           aria-current="page">自動入力</a>
      </li>
      <li className="w-full focus-within:z-10">
        <a href="#" key="manual" onClick={() => setAuto(false)}
           className=" items-center inline-block w-full p-4 bg-white border-r border-gray-200 dark:border-gray-700 hover:text-gray-700 hover:bg-gray-50 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700">手動入力</a>
      </li>
    </ul>
